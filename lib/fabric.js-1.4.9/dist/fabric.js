	...
	fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, /** @lends fabric.Canvas.prototype */ {
		...
		_searchPossibleTargets: function(e) {
			...
			while (i--) {
				...
				if (this._objects[i].type !== undefined && this._objects[i].type === "scene" && this._objects[i]._objects.length) {
					var objects = this._objects[i]._objects,
						objectsLength= objects.length,
						o = objectsLength;

					if ( objectsLength ) {
						while(o--) {
							//delete  objects[o].group;

							if (this._checkTarget(e, objects[o], pointer)){
								this.relatedTarget = objects[o];
								target = objects[o];
								break;
							}
	...
	fabric.util.object.extend(fabric.Canvas.prototype, /** @lends fabric.Canvas.prototype */ {
		...
		_collectObjects: function() {
			...
			for (var i = this._objects.length; i--; ) {
				...
				if ( currentObject.type === 'scene' && !currentObject.selectable) {
					for(var o = currentObject._objects.length; o--;) {
						sceneObject = currentObject._objects[o];
						if (!sceneObject || !sceneObject.selectable || !sceneObject.visible) continue;

						if (sceneObject.intersectsWithRect(selectionX1Y1, selectionX2Y2) ||
							sceneObject.isContainedWithinRect(selectionX1Y1, selectionX2Y2) ||
							sceneObject.containsPoint(selectionX1Y1) ||
							sceneObject.containsPoint(selectionX2Y2)
						) {
							sceneObject.set('active', true);
							group.push(sceneObject);
...
(function(global) {
	...
	fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
		...
		transform: function(ctx, fromLeft) {
			...
			//todo more reading object transform
...
(function() {
	...
	fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, /** @lends fabric.IText.prototype */ {
		 ...
		 * @return {fabric.IText} thisArg
		 */
		initialize: function(text, options, canvas) {
